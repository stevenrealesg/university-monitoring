...
function Monitor({ names, last_names, academy_program, dni, photo, phone, user, semester, email, handleDelete, setGetAgain, handleUpdate, userToUpdate }) {
                ...
                <div className="row g-0">
                    <div className="col-md-4">
                        <div className="h-100 d-flex align-items-center justify-content-center p-2">
                            <img src={urlPhoto} width={150} className="img-fluid rounded " alt="Foto" />
                        </div>
                    </div>
